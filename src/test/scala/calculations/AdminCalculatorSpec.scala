...
/*  "DataFrameHelper.generateCalculateAvgSQL" should {
  ...
  */
   ...
   /**
     * *+---------+----------+------------+--------+-----------+--------------+---------+----------------+----------------+------------+
     * |vat_group|       ern|      vatref|turnover|record_type|paye_employees|paye_jobs|group_empl_total|no_ents_in_group|grp_turnover|
     * +---------+----------+------------+--------+-----------+--------------+---------+----------------+----------------+------------+
     * |   999888|1100000004|999888777000|     260|          0|             4|        8|               4|               1|        null|
     * |   111222|1100000003|111222333000|     585|          1|            19|       20|              19|               1|       585.0|
     * |   111222|1100000003|111222333001|     590|          3|            19|       20|              19|               1|       585.0|
     * |   123123|2000000011|123123123000|     390|          0|             2|        4|               2|               1|        null|
     * |   555666|1100000004|555666777000|    1000|          1|             4|        8|               9|               2|      1000.0|
     * |   555666|1100000004|555666777001|     320|          3|             4|        8|               9|               2|      1000.0|
     * |   555666|1100000004|555666777002|     340|          3|             4|        8|               9|               2|      1000.0|
     * |   555666|2200000002|555666777003|     260|          3|             5|        5|               9|               2|      1000.0|
     * |   919100|9900000009|919100010000|      85|          2|          null|     null|            null|               1|        null|
     * +---------+----------+------------+--------+-----------+--------------+---------+----------------+----------------+------------+
   */
    testDF.show()
