...
//{"id":100000601835, "BusinessName": "MBI LTD", "UPRN": 789789, "PostCode": "CF23 9EU", "IndustryCode": "44044", "LegalStatus": "5", "TradingStatus": "X", "Turnover": "Y", "EmploymentBands": "Z", "VatRefs": [555666777003],"PayeRefs": ["9876L"], "CompanyNo": "01012444","ern":"5000000011"}
  val existingLinksForAddNewPeriodScenarion = List(
    ...
    HFileRow("01012444~CH~201803",List(KVCell("p_LEU","100000601835"))),
    ...
    HFileRow("100000601835~LEU~201803",List(KVCell("c_01012444","CH"), KVCell("c_9876L","PAYE"), KVCell("c_555666777003","VAT"), KVCell("p_ENT","5000000011"))),
    ...
    HFileRow("555666777003~VAT~201803",List(KVCell("p_LEU","100000601835"))),
    ...
    HFileRow("9876L~PAYE~201803",List(KVCell("p_LEU","100000601835"))),
    ...
    HFileRow("550000088~LOU~201803",List(KVCell("p_ENT","5000000011"))),
