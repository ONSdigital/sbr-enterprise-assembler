...
trait NewPeriodLinks {
  ...
  HFileRow("100000246017~LEU~201804",List(KVCell("c_00032262","CH"), KVCell("c_111222333","VAT"), KVCell("c_1152L","PAYE"), KVCell("c_1153L","PAYE"), KVCell("p_ENT","3000000011"))),

  HFileRow("100000459235~LEU~201804",List(KVCell("c_04223160","CH"), KVCell("c_1166L","PAYE"), KVCell("c_1177L","PAYE"), KVCell("c_222666000","VAT"), KVCell("c_555666777","VAT"), KVCell("p_ENT","4000000011"))),
                                        //CH c_01113199 changed from c_04223165
  HFileRow("100000508723~LEU~201804",List(KVCell("c_01113199","CH"), KVCell("c_111000111","VAT"), KVCell("c_1188L","PAYE"), KVCell("c_1199L","PAYE"), KVCell("p_ENT","4000000011"))),
                                                                     //PAYE ref 3333L added with update
  HFileRow("100000508724~LEU~201804",List(KVCell("c_00012345","CH"), KVCell("c_3333L","PAYE"), KVCell("c_5555L","PAYE"), KVCell("c_999888777","VAT"), KVCell("p_ENT","4000000011"))),
                                      //CH 04186804 changed from 00032263
  HFileRow("100000827984~LEU~201804",List(KVCell("c_04186804","CH"), KVCell("c_1154L","PAYE"), KVCell("c_1155L","PAYE"), KVCell("c_222333444","VAT"), KVCell("p_ENT","3000000011"))),
                          //c_00032261 CH removed
  HFileRow("100002826247~LEU~201804",List(KVCell("c_1151L","PAYE"),  KVCell("c_123123123","VAT"), KVCell("p_ENT","2000000011"))),
  ...
  HFileRow("2000000011~ENT~201804",List(KVCell("c_100002826247","LEU"), KVCell("c_200000099","LOU"))),
  HFileRow("200000099~LOU~201804",List(KVCell("p_ENT","2000000011"))),
  HFileRow("222333444~VAT~201804",List(KVCell("p_LEU","100000827984"))),
  HFileRow("222666000~VAT~201804",List(KVCell("p_LEU","100000459235"))),
  HFileRow("3000000011~ENT~201804",List(KVCell("c_100000246017","LEU"), KVCell("c_100000827984","LEU"), KVCell("c_300000088","LOU"), KVCell("c_300000099","LOU"))),
  ...
  HFileRow("4000000011~ENT~201804",List(KVCell("c_100000459235","LEU"), KVCell("c_100000508723","LEU"), KVCell("c_100000508724","LEU"), KVCell("c_300000055","LOU"), KVCell("c_300000066","LOU"), KVCell("c_300000077","LOU"))),
  ...
  HFileRow("999000508999~LEU~201804",List(KVCell("c_33322444","CH"), KVCell("c_919100010","VAT"), KVCell("p_ENT","5000000011"))), // new LEU
