...
import global.AppParams.{DEFAULT_GEO_PATH, DEFAULT_GEO_PATH_SHORT}
...
case class AppParams(
  ...
  val PATH_TO_GEO_SHORT = DEFAULT_GEO_PATH_SHORT
}
...
object AppParams{
  ...
  val DEFAULT_GEO_PATH_SHORT = "src/main/resources/data/geo/test_short-dataset.csv"
